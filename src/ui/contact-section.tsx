...
import { ContactFormData, submitContactForm } from "@/actions/submitContactForm";

export const initialData: ContactFormData = {
	name: "",
	email: "",
	message: "",
	privacy: false,
			...
			<div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8">
				<div className="border-border rounded-lg border p-8">
					<div className="mb-8 text-center">
						<h2 id="contact-heading" className="gradient-text mb-4 text-3xl font-bold md:text-4xl">
							Get in Touch
						</h2>
					...
					<form action={formAction} className="space-y-4">
						<div className="grid grid-cols-1 gap-6">
							<div className="space-y-2">
								...
								/>
								{state.errors?.name && (
									<div className="flex items-center space-x-1" id="name-error">
						...
						<div className="space-y-2">
							...
							{state.errors?.message && (
								<div className="flex items-center space-x-1" id="message-error">
									<AlertCircle className="h-4 w-4 text-red-500" />
									<span className="text-sm text-red-500">{state.errors.message[0]}</span>
								</div>
							)}
						</div>
